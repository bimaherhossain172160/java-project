...
JOptionPane.showMessageDialog(null," Please enter movie name first.");
    ...
    try {
    PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("d://MovieDetails.txt", true)));
     out.print(","+moviename.getText()+";"+movieLang.getSelectedItem()+";"+movieTime.getSelectedItem());
    out.close();
            } catch (IOException e) {
    e.printStackTrace();
                                    }        
